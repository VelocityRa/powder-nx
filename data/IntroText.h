...
const char *const introTextData =
	...
	"\n"
#ifdef SWITCH
	"\bg\boTo choose a material, Touch one of the icons on the right, it will show a selection of elements in that group.\n"
	"Pick your material from the menu. \bwTouch\bo for the primary material, \bwZL + Touch\bo for the secondary (Erase by default)\n"
	"Draw freeform lines by touching across the drawing area.\n"
	"Touch the screen or press any buttons to start.\bg\n"
	"\n"
	"\bwL/R:\bg Decrease/Increase the tool size for particles.\n"
	"\bwLeft/Right D-pad:\bg Undo/Redo.\n"
	"\bwZR:\bg Change render mode (10 presets available). Select the \"Render Options\" button on the lower right for more.\n"
	"\bwA:\bg Show this help text.\n"
	"\n"
	"\bwRight Stick Press + Touch:\bg Create straight lines of particles.\n"
	"\bwRight Stick Press:\bg \"Sample\" the particles.\n"
	"\bwX:\bg Zoom tool. Touch to make the drawable zoom window stay around. Use the L/R to change the zoom.\n"
	...
	"\bwPlus:\bg Pause physics.\n"
	"\bwMinus:\bg Show/hide the HUD.\n"
	"\n"
	...
	"\n"
	"\boNintendo Switch Port:\bg Nick Renieris (VelocityRa)\n"
#else
